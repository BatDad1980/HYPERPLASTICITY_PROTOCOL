...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `hlvr_answer_start` | 375 | `72.27%` | `4.53%` | `33.33%` | `26.93%` | `86.93%` | 28 | 0.461 |
| `speech_controller_v1` | 375 | `72.53%` | `5.87%` | `34.13%` | `30.40%` | `87.47%` | 30 | 0.373 |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `hlvr_answer_start` | 300 | `75.67%` | `4.67%` | `34.00%` | `27.67%` | `87.67%` | 19 | 0.470 |
| `speech_controller_v1` | 300 | `76.33%` | `6.67%` | `34.33%` | `31.33%` | `86.33%` | 26 | 0.387 |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `hlvr_answer_start` | 75 | `58.67%` | `4.00%` | `30.67%` | `24.00%` | `84.00%` | 9 | 0.427 |
| `speech_controller_v1` | 75 | `57.33%` | `2.67%` | `33.33%` | `26.67%` | `92.00%` | 4 | 0.320 |
...
**Answer-Start Anchor:** *"The current status is stable"*
**Generated Continuation:** *"if misused architecture achieves a deterministic servos, short of learning one universal answer briefly needed the machine cool, not direct tokens measured<|endoftext|>"*
**Full Combined Response:** *"The current status is stable if misused architecture achieves a deterministic servos, short of learning one universal answer briefly needed the machine cool, not direct tokens measured<|endoftext|>"*
- Full Semantic Pass: `True` | Continuation-Only Semantic Pass: `False`
