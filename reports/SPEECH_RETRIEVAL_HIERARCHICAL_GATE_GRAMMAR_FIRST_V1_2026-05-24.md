...
- **Vector Cosine Similarity Threshold ($T_{vec}$)**: `0.8800`
...
| :--- | :---: | :--- |
| **Raw Vector Similarity** | `0.7387` | Matches raw query prompt against raw memory in embedding space |
| **Normalized Key Match** | `0.8` | Matches exact normalized keys (fails on paraphrases) |
| **Normalized Vector Similarity** | `0.872` | Matches normalized query against normalized memory in embedding space |
...
| `paraphrase` | 75 | 0.3867 | 0.0000 | 0.3600 | 0.7467 | 0.7600 | 0.5733 | 0.7467 |
| `please_answer` | 75 | 0.7600 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.6667 | 0.9867 |
| `simple_terms` | 75 | 0.8400 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.6667 | 0.9867 |
