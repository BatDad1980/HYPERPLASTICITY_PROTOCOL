...
| :--- | :---: | :--- |
| **Raw Vector Similarity** | `0.744` | Matches raw query prompt against raw memory in embedding space |
| **Normalized Key Match** | `0.8` | Matches exact normalized keys (fails on paraphrases) |
| **Normalized Vector Similarity** | `0.88` | Matches normalized query against normalized memory in embedding space |
...
- **Overall Surface Pass**: `342/375 (91.20%)`
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `bounded` | 75 | 0.6800 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.6533 | 0.9467 |
| `exact` | 75 | 0.9867 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.6533 | 0.9733 |
| `paraphrase` | 75 | 0.3600 | 0.0000 | 0.4000 | 0.7467 | 0.7600 | 0.5467 | 0.7333 |
| `please_answer` | 75 | 0.8267 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.6667 | 0.9600 |
| `simple_terms` | 75 | 0.8667 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.6533 | 0.9467 |
...
- retrieved by Raw Vector: "What should we check first?"
- retrieved by Normalized Vector: "What should a robot do before moving?"
- retrieved by BM25: "What are you in this project?"
